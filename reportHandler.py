...
def updateReport(url, tokenFrequencyDict):
    ...
    MYREPORT.writelines("most words: " + str(MOSTWORDS))
    MYREPORT.writelines("url with most words: " + MOSTWORDSURL)
    MYREPORT.writelines("number of unique pages: " + str(NUMUNIQUEPAGES))
    MYREPORT.close()